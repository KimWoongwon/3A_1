...
namespace UnityEngine.UI.Extensions
{
    ...
    {     
        ...
        #region IMeshModifier ¸â¹ö

        public void ModifyMesh(VertexHelper vertshelper)
        {

            List<UIVertex> verts = new List<UIVertex>();
            vertshelper.GetUIVertexStream(verts);
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                // Apply
                tempvertex.position = v;
                verts[i] = tempvertex;
            }


            vertshelper.Clear();
            vertshelper.AddUIVertexTriangleStream(verts);
