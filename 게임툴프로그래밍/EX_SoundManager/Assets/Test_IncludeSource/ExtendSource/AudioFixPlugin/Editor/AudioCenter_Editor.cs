...
// 
[CustomEditor(typeof(AudioCenter))]
public class AudioCenter_Editor : Editor
{
...
//         BeepAudioClipArr = Resources.LoadAll<AudioClip>(m_ExtendSoundFolder
    ...
    AudioCenter m_targetobj = null;
    void OnEnable()
    {
        m_targetobj = target as AudioCenter;
    ...
    protected void Editor_AdjustSoundFile(string p_assetfile)
    {
        ...
        m_targetobj.BeepAudioClipArr = m_TempAudioClipList.ToArray();
