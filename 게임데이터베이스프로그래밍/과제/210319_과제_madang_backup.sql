...
CREATE TABLE `orders` (
  ...
  KEY `Order_fk_01_idx` (`custid`),
  KEY `Order_fk_02_idx` (`bookid`),
  CONSTRAINT `Order_fk_01` FOREIGN KEY (`custid`) REFERENCES `customer` (`custid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `Order_fk_02` FOREIGN KEY (`bookid`) REFERENCES `book` (`bookid`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-19 10:55:12
